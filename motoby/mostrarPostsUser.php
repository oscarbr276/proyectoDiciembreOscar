    ...
    $row = $stmt->fetchAll(PDO::FETCH_ASSOC);
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <span class="description">Compartido el <?php echo $row['fecha_publicacion']?></span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                    ...
                    <button class=" btn btn-danger " onclick="confirmarEliminacion(<?php echo $row['post_id']; ?>)">Eliminar</button>
          ...
          <hr>
                  ...
                  <?php } 
                   ...
                   ?> <a href="crearPost.php"> <button type="button"  class="btn btn-block btn-success btn-lg">Crear publicacion</button></a> <?php
                }?>
                  <!-- /.tab-pane -->
                </div>
...
function confirmarEliminacion(postId) {
    var confirmacion = confirm("¿Estás seguro de eliminar este post?");
