        ...
        <div class="row">
          <div class="col-md-6" >
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="guardarProducto.php" id="myForm" enctype="multipart/form-data" method="POST">
                <div class="card-body" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="image" placeholder="añade imagen" required>
                  </div>
                </div>
                <!-- /.card-body -->
