        ...
        <div class="row">
          <div class="col-md-6" >
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="guardarPost.php" id="myForm" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Nombre</label>
                    <textarea id="contenido" type="textarea" class="form-control" name="content" placeholder="Añade un post...  " required></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
